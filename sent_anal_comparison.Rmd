...
cluster_1_artists = cluster_1_artists %>% inner_join(artist_song_counts, by = "artist") %>% mutate(prop = n.x / n.y)
cluster_1_artists = cluster_1_artists %>% mutate(highlight = ifelse(artist == "Taylor Swift", "yes", "no"))
```
